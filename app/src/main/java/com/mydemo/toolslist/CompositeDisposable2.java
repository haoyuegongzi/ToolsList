 ...
 */
public final class CompositeDisposable2 implements Disposable, DisposableContainer {
     ...
     */
    public CompositeDisposable2(@NonNull Disposable... disposables) {
     ...
     */
    public CompositeDisposable2(@NonNull Iterable<? extends Disposable> disposables) {
        ObjectHelper.requireNonNull(disposables, "disposables is null");
